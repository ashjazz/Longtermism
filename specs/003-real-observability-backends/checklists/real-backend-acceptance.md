...
- [ ] CHK015 Is the local `content_raw` policy reconciled with the earlier assumption that raw content never enters observability? [Conflict, Workbench §决策 3, §决策 7]
